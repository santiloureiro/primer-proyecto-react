                ...
                <div className="flex shadow-md w-[90vw] my-10">
                    ...
                    <div className="w-3/4 bg-white px-10 py-10">
                        <div className="flex justify-between border-b pb-8">
                            ...
                            <h2 className="font-semibold text-2xl">{contexto.cart.lenght} Items</h2>
                        </div>
                        ...
                        {contexto.cart.map((item,i) => (
                                            ...
                                            <div className="w-20">
                                                ...
                                                <div className="flex flex-col justify-between ml-4 flex-grow">
                                                    ...
                                                    <button onClick={()=> {contexto.cart.pop([i])}} className="font-semibold hover:text-red-500 text-gray-500 text-xs">Remove</button>
                                                </div>
                                            </div>
