...
const ItemQuantitySelector = ({add1, minus1, noMore, stateVal, alert, func}) => {
    ...
    return (
        <div className="flex text-white h-fit border border-slate-200 w-fit rounded-sm">
            ...
            {alert ? (<div id="toast-danger" class="flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-slate-200 absolute bottom-0 right-0 transition-all" role="alert">
